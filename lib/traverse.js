...
Traverse.prototype.setStartProgram = function(startProgram) {
  this.startProgram = startProgram;
};

Traverse.prototype.setEndProgram = function(endProgram) {
  this.endProgram = endProgram;
};

Traverse.prototype.setStartFunc = function(startFunc) {
  this.startFunc = startFunc;
};

Traverse.prototype.setEndFunc = function(endFunc) {
  this.endFunc = endFunc;
};

Traverse.prototype.generate = function() {
  return escodegen.generate(this.replace());
};

Traverse.prototype.replace = function(){
